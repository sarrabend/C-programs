...
void menu_partie1()
{
    ...
    {
    case 1:
        printf("\n\n        Donnez le nom de famille a rechercher SVP : ") ; scanf("%s",NOM) ;
        present(NOM,p,&q,&l);
    ...
    break;
    case 2:
        printf("\n\n  Donnez le nom de famille a inserer SVP: ") ; scanf("%s",NOM) ;
        present(NOM,p,&q,&l);
        if (l==NULL)
        {inser_nom(NOM,&p);
    ...
    break;
    case 3:
        printf("\n\n  Donner le nom de famille a supprimer SVP : ") ; scanf("%s",NOM) ;
        present(NOM,p,&q,&l);
        if (l!=NULL)
        {
            supp_nom(NOM,&p);
...
{   pf f,q,p;
    ...
    char s ;
    printf("\nPARTIE 2:\n");
    printf("veuillez entrer le nombre de familles de votre population:");
    scanf("%d",&n);
    f=creer_fam_triee(n);
    afficher_f(f);
    printf("On considere une population pop composee de plusieurs familles\n");
    printf("vous avez le choix au traitement suivant :\n");
    printf("    1 - le nombre de familles de  dont les parents sont decedes.\n");
    printf("    2 - renvoie le nombre d'enfants de la communautee.\n");
    printf("    3 - renvoie le nombre d'enfants d'une famille donnee si elle appartient a la communautee elle renvoie 0 sinon.\n");
    printf("    4 - inserer le prenom et le sexe du nouveau-ne dans pop si nomfam appartient a pop.\n");
    printf("    5 - rechercher la voiture d'une famille -premiere methode-.\n");
    printf("        ->choisissez un traitement \n");
    scanf("%d",&partie2);
    switch(partie2)
    {
        ...
        break;
        case 3:
        printf("\ndonner le nom de famille :"); scanf("%s",nomfam);
        ...
        if (p!=NULL)
        {
         printf("\nentrer le prenom du nouveau-ne ainsi que son sexe :\n");
         printf("le prenom :");
         scanf("%s",nomne);
         printf("le sexe :");
         while(getchar()!='\n');
        ...
        else {printf("cette famille n'existe pas dans pop "); }
        printf("\n\ncliquer sur entrer pour continuer");
        getch();
        system("cls");
          break;
...
printf("                                  _            _     _   _\n");
printf("  _ __     ___    _ __    _   _  | |    __ _  | |_  (_) (_)   ___    _ __ \n");
printf(" | '_ \\   / _ \\  | '_ \\  | | | | | |  / _`  | | __| | | | |  / _ \\  | '_ \\ \n");
printf(" | |_) | | (_) | | |_) | | |_| | | |  | (_| | | |_  | | | | | (_) | | | | |\n");
printf(" | .__/   \\___/  | .__/   \\__,_| |_|   \\__,_|  \\__| |_| |_|  \\___/  |_| |_|\n");
printf(" |_|             |_|                                                          \n\n");
...
system("cls");
    ...
    printf("Cliquer sur entrer pour lancer le programme .\n");
    getch();
    printf("On s'interessera a une communaute algerienne composee de plusieurs familles  limitees a deux generations.\n on a deux parties : \n ");
    printf("\n1 - On se limitera a des familles composees uniquement des noms de familles dans la PREMIERE PARTIE.\n ");
    printf("\n2 - On ajoutera dans la DEUXIEME PARTIE les parents, les enfants et les voitures possedees par une famille.  ");
